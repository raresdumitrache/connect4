...
public class NetworkCommunication {
	...
	private CommunicationClient mCommunicationClient;
	...
	public NetworkCommunication(Handler handler) {
		...
		mCommunicationServer = new CommunicationServer(handler);
	}
	...
	public void connectToServer(InetAddress address, int port) {
		mCommunicationClient = new CommunicationClient(address, port);
	}

	public void sendMessage(String msg) {
		if (mCommunicationClient != null) {
			mCommunicationClient.sendMessage(msg);
		}
	}
	...
	public synchronized void updateMessages(String msg, boolean local) {
		...
		if (local) {
			Log.e(TAG, "---->I have SENT the message: " + msg);
		} else {
			Log.e(TAG, "----<I have RECEIVED the message: " + msg);
	...
	private class CommunicationServer {
		ServerSocket mServerSocket = null;
		Thread mThread = null;

		public CommunicationServer(Handler handler) {
	...
	private class CommunicationClient {

		private InetAddress mAddress;
		private int PORT;

		private final String CLIENT_TAG = "CommunicationClient";
		...
		public CommunicationClient(InetAddress address, int port) {
			...
			Log.d(CLIENT_TAG, "Creating CommunicationClient");
